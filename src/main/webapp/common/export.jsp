...
<%
    /*
             호출방법
     AUIGrid.setProperty(myGridID, "exportURL", "/common/export.jsp");
     AUIGrid.exportAsXlsx(myGridID, true, {fileName : "2013년_지역별_매출_내역(AUIGrid)"});
     */
    ...
    // AUIGrid.exportAsXlsx() 사용시 exportProps 로 파일명을 지정해 줬다면 다음과 같이 지정된 파일명을 얻을 수 있습니다.
    ...
    String fileName = request.getParameter("filename") + "." + extension; // 파라메터 파일명 
