    ...
    <div id="container">
        <div class="sub_content">
            <form id="applyFrm" onsubmit="return false">
                ...
                <!-- signature -->
                <div class="md_apply">
                    <div class="text">위 사람은 「친환경농어업 육성 및 유기식품 등의 관리·지원에 관한 법률 시행규칙」 별표 3 제2호, 제3호, 제4호 및 <br>별표 11 제1호, 제2호에 따른 인증기준 이행 교육을 이수하였음을 증명합니다. </div>
                    <div class="text txtR">
