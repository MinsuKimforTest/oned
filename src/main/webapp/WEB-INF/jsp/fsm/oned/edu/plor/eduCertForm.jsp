    ...
    <div id="container">
        <div class="sub_content">
            <form id="applyFrm" onsubmit="return false">
                ...
                <div class="table_popup">
                    <table class="table_col responsive">
                        ...
                        <tbody>
                            ...
                            <tr style="height: 40px">
                                <th>교육명</th>
                                <td colspan="3">수산물 원산지 표시제도 명예감시원 교육</td>
                            </tr>
                            <tr style="height: 40px">
                                <th>교육이수시간</th>
                                <td colspan="3">총 2시간(인터넷 강의 6강 전 과정 이수)</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <!-- signature -->
                <div class="md_apply">
                    <div class="text">위 사람은 「농수산물의 원산지 표시 등에 관한 법률」 제11조 및 「수산물 명예감시원 운영요령」 제8조에 따라 실시한 명예감시원 교육과정을 성실히 이수하였음을 증명합니다. </div>
                    <div class="text txtR">
