    ...
    <div id="container">
        <div class="sub_content">
            <form id="applyFrm" onsubmit="return false">
                    ...
                    <table class="table_col responsive mt5 mb20">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <span><em style="padding: 0 5px">*</em>친환경수산물 인증 신청 단위와 동일하게 선택</span>
                            </td>
                        </tr>
                        <tr>
                            <th>업체명(성명) <em>*</em></th>
                ...
                <!-- signature -->
                <div class="md_apply">
                    <div class="text"><span class="eduAplyYear"></span>년 친환경수산물 등 인증사업자 교육을 신청합니다.</div>
                        ...
                        <tr>
                            <td>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <th>수집·이용 목적</th>
                                        <td>친환경수산물 등 인증사업자 외부교육 이수관리</td>
                                    </tr>
                                    <tr>
                                        <th>수집·이용 항목</th>
...
<script>
    ...
    var selectEduApplyWorkOptions = function(pTargetId,pParam){
        pParam.pUrl = "/edu/selectEduApplyWorkOptions.do?EDU_APLY_UNIT="+$("#EDU_APLY_UNIT").val();
