...
<script>
    ...
    var fnSearch = function(pSelectPage) {
        ...
        lpCom.Ajax("search", "/edu/plor/selectPlanList.do", param, calBackFunc, otherInit);
    }
    ...
    var fnMoveDetail = function(eduId) {
        ...
        lpCom.hrefOrSubmit("/edu/plor/planDetail.do?EDU_ID=" + eduId ,postData);
    }
    ...
    var fnMoveEduApplyForm = function(eduId) {
        ...
        if(checkYn == "N"){
            ...
            opt.scrollbars = "yes";
            opt.resizable = "yes";
            lpCom.winOpen('/edu/plor/applyForm.do', "PLOR 교육신청", params, opt);
        }
    }
    /*===================================================사용자 함수종료 시작 =================================*/
</script>
