    ...
    <div id="container">
        ...
        <div class="sub_content">
            ...
            <form id="schFrm" onsubmit="return false">
                ...
                <input type="hidden" id="BOARD_TYPE" value="<c:out value="${boardInfo.BOARD_TYPE}"/>" />
...
<script>
    ...
    var fnSetObjectEvent = function() {
        {//click 이벤트 활당
            ...
            $("#regiBtn").on("click", function(e) {
                lpCom.href("/board/actionBoardForm.do?MENU_ID=<c:out value="${boardInfo.MENU_ID}"/>&BOARD_ID=<c:out value="${boardInfo.BOARD_ID}"/>");
            });
    ...
    var fnSearch = function(pSelectPage) {
        ...
        lpCom.Ajax("search", "/board/selectBoardList.do", param, calBackFunc, otherInit);
    }
    ...
    var fnMoveDetail = function(ordNo, passwordAt) {
        if(passwordAt == "Y"){
            ...
            lpCom.hrefOrSubmit("/board/actionBoardDetail.do?MENU_ID=<c:out value="${boardInfo.MENU_ID}"/>&BOARD_ID=<c:out value="${boardInfo.BOARD_ID}"/>&ORD_NO=" + ordNo, postData);
        }
    }
    /*===================================================사용자 함수종료 시작 =================================*/
</script>
