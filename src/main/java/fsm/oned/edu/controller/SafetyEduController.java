...
@Slf4j
@Controller
@RequestMapping("/edu/safety")
public class SafetyEduController extends BaseEduController {
    
    @Override
    protected String getEduType() {
        return EDU_TYPE_SAFETY;
    }
    
    @Override
    protected String getJspPath() {
        return JSP_PREFIX + "safety" + JSP_SUFFIX;
    }

    /**
     * SAFETY 교육신청 - 리스트 화면이동
